...
sealed class SavedCities {

    companion object {

        @Composable
        fun SavedCitiesScreen(
            activity: MainActivity, savedCitiesState: State<List<SavedCityEntity>>
        ) {
            Surface(
                modifier = Modifier
                    .fillMaxWidth()
                ...
                Column(
                    ...
                    Surface(
                        ...
                        val cities = savedCitiesState.value
                    ...
                    Button(
                        onClick = {
                            activity.navigateToFavoritesScreen()
                        },
                        modifier = Modifier
                            .fillMaxWidth()
                            .padding(start = 30.dp, top = 10.dp, end = 30.dp, bottom = 10.dp),
